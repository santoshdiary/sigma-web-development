...
const newArr=myArr.join(); // used to join (String) 
console.log(myArr); //returns in array array format
...
console.log("B", myArr)
const myn2=myArr.splice(1,3);// NOTE, it includes 3 index as well as it move the element of myArr from index 1 to 3 .
console.log(myn2);
//proof
